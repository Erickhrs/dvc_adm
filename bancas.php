        ...
        <main id="root">
            ...
            <div class="table-data">
                <div class="questionType" style="background: none;">
                    ...
                    <a href="./bancas.php" id="" class="userType-active"><i class='bx bx-coin'></i>Banca</a>
            ...
            <div class="atrContainers">
                ...
                <div class="order"
                    ...
                    <div class="head">
                        <h3>Adicionar nova banca</h3>
                        <span style="font-size: 11px;">Escreva o nome da banca</span>
                    </div>
                    <form action="./actions/in_banca.php" method="post">
                        <input type="text" name="newBanca" id="" required>
                        <button type="submit"
                            style="    border: none;background-color: greenyellow;height: 30px;width: 30px;border-radius: 25px;cursor: pointer;"><i
                                class='bx bx-check'></i></button>
                    </form>
                    <div class="head">
                        <h3>Excluir Bancas</h3>
                        <span style="font-size: 11px;">Escreva o texto de validação e informe o ID e o nome</span>
                    </div>
                    <form action="./actions/deletingBanca.php" method="post">
                        ...
                        <input type="text" name="atr_name" id="" value="" placeholder="escreva o nome da Bancas"
                            required>
                        <button type="submit"
